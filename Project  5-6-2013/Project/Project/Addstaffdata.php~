...
$ins = "INSERT INTO staff (fname,mname,lname,email,phone,ms,landmark,room,city,state,pin,radio,Nation,roll,dob) VALUES ('$fname','$mname','$lname','$email','$phone','$ms','$room','$land','$city','$state','$zip','$radio','$nation','$roll','$dob') ";
mysql_query($ins);
...
<div class="field" style="margin-top:40px;">
	<span class="lbl">Year</span>
  	<select style="height:30px; width:120px;border-radius: 0px;border:hidden;padding:0px 0px 0px 10px; " class="input">
				   <option>F.Y.Bsc.(I.T)</option>
                   <option>S.Y.Bsc.(I.T)</option>
                   <option>T.Y.Bsc.(I.T)</option>
...
<div class="field"style="margin-top:40px;">
    ...
    <input type="radio" name="radio1" value="Male" style="margin-left:0px;margin-top:8px;" CHECKED/><span style="margin-left:10px; color:#FFF;">Male</span>
    <input type="radio"name="radio1"  value="Female" style="margin-left:10px;margin-top:8px;"/><span style="margin-left:10px;color:#FFF;">Female</span>
</div>
</div>
<div id="rightdiv">
<fieldset>
