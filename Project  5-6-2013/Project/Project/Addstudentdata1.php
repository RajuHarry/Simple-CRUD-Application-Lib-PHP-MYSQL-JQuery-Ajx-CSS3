...
$ins = "INSERT INTO student1 (fname,mname,lname,email,phone,ms,landmark,room,city,state,pin,radio,class,Nation,roll,dob) VALUES ('$fname','$mname','$lname','$email','$phone','$ms','$room','$land','$city','$state','$zip','$radio','$class','$nation','$roll','$dob') ";
mysql_query($ins);
