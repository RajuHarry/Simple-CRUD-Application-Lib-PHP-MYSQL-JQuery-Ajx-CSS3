...
<?php
	echo "<div style='text-shadow: 0px 0px 5px #000; color:#FFF;margin-left:22px;'>Uloaded image:</div><span style='margin-left:24px;text-shadow:none;color:#000;'>$img</span> <br/><img src='img/$img' style='width:350px; height:200px; padding:24px;'/>";
