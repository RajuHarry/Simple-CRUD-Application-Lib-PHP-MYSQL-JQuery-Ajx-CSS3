...
{
	$id = $_GET['id'];
	$sel = mysql_query("select * from student1 where id=$id");
...
$update = "update student1 set fname='$fname',mname='$mname',lname='$lname',email='$email',phone='$phone',ms='$ms',landmark='$land',room='$room',city='$city',state='$state',pin='$zip',radio='$radio',class='$class',nation='$nation',roll='$roll',dob='$dob' where id=$id ";

$res=mysql_query($update);

echo '<script> location.href="Addstudentdata.php" </script>'; 
...
<title>Update Edit Student DB</title>
...
<script type="text/javascript">
		function Prompt()
  			{
  				alert("Student Record Updated sccsessfully");
  			}
...
<div id="formlayout">
<div id="headeradd">
<h3 align="center" style="padding-top:10px;">Update Form Student</h3>
</div>
<div id="leftdiv" >
