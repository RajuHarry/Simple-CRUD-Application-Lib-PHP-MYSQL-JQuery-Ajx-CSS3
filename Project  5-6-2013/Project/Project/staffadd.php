...
if(isset($_GET['id']))
    {
    $id = $_GET['id'];
    $del_query="delete from staff where id='$id'";
...
if (isset($_GET['searchname']) && isset($_GET['searchby'])) {
  //  echo $_GET['searchby'];
    ...
    $sel = mysql_query("select * from staff where $searchby='$searchname' ");
  //  echo $sel;
}
        ...
        <script>
            function suggest(inputString, list) {
                ...
                if (inputString.length == 0) {
                    ...
                    $.post("autosuggest.php", {queryString: "" + inputString + "", list: "" + selectVal + ""}, function(data) {
                        if (data.length > 0) {
                            $('#suggestions').fadeIn();
...
<div style="float:left"><h2 style=" color:#FFF; padding:0px 10px 0px;text-shadow: 0px 0px 5px #000; ">Staff Record</h2></div>
...
<thead>        
  ...
  <tr>
   <td ><input type="checkbox" id='del[]' value='<?php echo $row['id']; ?>' name='del[]'></td>
    ...
    <td><a href="otherstaff.php?id=<?php echo $row['id']; ?> "><img src="images/vcard.png" title="Other Details" alt="Other Details" class="icondetail"/></a></td>
    <td><a href="Editstaff.php?id=<?php echo $row['id']; ?> "><img src="images/Edit.png" title="Edit" alt="Edit"  class="iconimg"/></a></td>
    <td><a onclick="return del();" href="staffadd.php?id=<?php echo $row['id']; ?>"><img src="images/del7.png" title="Delete" alt="Delete" class="iconimg"/></a></td>
...
<center><div id="pageNavPosition" style="margin:20px;"></div></center>
   ...
   <center><a href="Addstaffdata.php"><input type="button" value="ADD" name="add" style=" margin:20px 0px;" /></a>
